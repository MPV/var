...
<Tabs syncKey="lang">
  ...
  <TabItem label="Go">
    ...
    r := oselvar.DefineState[Ctx]()

    r.Stimulus("I add {int}", func(c Ctx, n int) Ctx { return Ctx{Total: c.Total + n} })
    r.Sensor("the total is {int}", func(c Ctx, expected int) int { return c.Total })
    ```
  </TabItem>
</Tabs>
...
<Tabs syncKey="lang">
  ...
  <TabItem label="Go">
    ```go
    r.Sensor("the alarm fired", func(c Ctx) error {
    	if !c.Alarm {
...
<Tabs syncKey="lang">
  ...
  <TabItem label="Go">
    ```go
    type Ctx struct{ Dice []int }

    r := oselvar.DefineState[Ctx]()
    r.DefineParameterType("numbers", `\d+(?:, \d+)*`, func(args ...string) any {
    ...
    // "The dice show 5, 6" — {numbers} transforms to [5, 6]
    r.Sensor("The dice show {numbers}", func(c Ctx, dice []int) []int { return c.Dice })
    ```
  </TabItem>
</Tabs>
...
<Tabs syncKey="lang">
  ...
  <TabItem label="Go">
    ```go
    r.Sensor("I should have {int} cukes in my {word} belly", func(c Ctx, count int, belly string) []any {
    	return []any{c.Count, c.BellyName}
    })
    ```
  </TabItem>
</Tabs>
...
<Tabs syncKey="lang">
  ...
  <TabItem label="Go">
    ```go
    r.Sensor("Greet {word}:", func(c Ctx, name string, doc string) []any {
    	return []any{name, "Hello, " + name + "!\n"}
    })
    ```
  </TabItem>
</Tabs>
...
<Tabs syncKey="lang">
  ...
  <TabItem label="Go">
    ```go
    r.Sensor("a decimal and a roman number", func(c Ctx, row map[string]string) map[string]string {
